...
export default component$(() => {
  return (
    <div class="relative bg-white/80 dark:bg-gray-900/80 overflow-hidden flex items-center justify-center mx-1.5 mt-1 mb-2 border-radius-dot-25 rounded-lg">
      ...
      <section class="relative rounded-lg  md:-mt-[76px] not-prose mx-1.5 my-1.5 bg-white/75 dark:bg-gray-900/75 border-radius-dot-25">
        ...
        <div class="relative max-w-7xl mx-auto px-4 sm:px-10 ">
          ...
          <div class="pt-6 md:py-20 lg:py-0 lg:flex lg:items-center lg:h-screen lg:gap-8">
            ...
            <span class="text-xs bg-[#70C7BA] rounded-full text-white px-4 py-1.5 mr-3">New</span> <span class="text-sm font-medium">Latest Koin announcements go here</span> 
            <svg class="ml-2 w-5 h-5" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M7.293 14.707a1 1 0 010-1.414L10.586 10 7.293 6.707a1 1 0 011.414-1.414l4 4a1 1 0 010 1.414l-4 4a1 1 0 01-1.414 0z" clip-rule="evenodd"></path></svg>
              ...
              <div class="max-w-3xl mx-auto lg:max-w-none">
                <p class="text-xl mb-6 dark:text-slate-300">
                  Join the fun with <span class="font-semibold">KOIN</span>—the hottest memecoin on the Kaspa chain. Everyone needs some Koin in their wallet.
                </p>
